...
umain(int argc, char **argv)
{
  ...
  800041:	89 c3                	mov    %eax,%ebx
	...
	if (thisenv == &envs[1]) {
  800043:	81 3d 08 20 80 00 80 	cmpl   $0xeec00080,0x802008
  80004a:	00 c0 ee 
  ...
  800090:	c7 04 24 f1 14 80 00 	movl   $0x8014f1,(%esp)
  ...
  8000bc:	e8 5d 10 00 00       	call   80111e <ipc_send>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800252:	e8 d9 0f 00 00       	call   801230 <__udivdi3>
  ...
  8002a5:	e8 b6 10 00 00       	call   801360 <__umoddi3>
  8002aa:	89 7c 24 04          	mov    %edi,0x4(%esp)
  8002ae:	0f be 80 12 15 80 00 	movsbl 0x801512(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8003d6:	ff 24 85 00 16 80 00 	jmp    *0x801600(,%eax,4)
		case '6':
		case '7':
		case '8':
		case '9':
  ...
  8004b4:	c7 44 24 04 2a 15 80 	movl   $0x80152a,0x4(%esp)
  8004bb:	00 
  ...
  8004da:	c7 44 24 04 2e 15 80 	movl   $0x80152e,0x4(%esp)
  8004e1:	00 
  ...
  800500:	c7 44 24 04 32 15 80 	movl   $0x801532,0x4(%esp)
  800507:	00 
  ...
  800526:	c7 44 24 04 36 15 80 	movl   $0x801536,0x4(%esp)
  80052d:	00 
  ...
  80054c:	c7 44 24 04 3a 15 80 	movl   $0x80153a,0x4(%esp)
  800553:	00 
  ...
  800572:	c7 44 24 04 3e 15 80 	movl   $0x80153e,0x4(%esp)
  800579:	00 
  ...
  8005e4:	c7 44 24 08 4b 15 80 	movl   $0x80154b,0x8(%esp)
  8005eb:	00 
  ...
  800619:	b8 23 15 80 00       	mov    $0x801523,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800d92:	00 
  800d93:	c7 44 24 08 84 17 80 	movl   $0x801784,0x8(%esp)
  800d9a:	00 
  800d9b:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800da2:	00 
  800da3:	c7 04 24 a1 17 80 00 	movl   $0x8017a1,(%esp)
  800daa:	e8 25 04 00 00       	call   8011d4 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800e51:	00 
  800e52:	c7 44 24 08 84 17 80 	movl   $0x801784,0x8(%esp)
  800e59:	00 
  800e5a:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e61:	00 
  800e62:	c7 04 24 a1 17 80 00 	movl   $0x8017a1,(%esp)
  800e69:	e8 66 03 00 00       	call   8011d4 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800eaf:	00 
  800eb0:	c7 44 24 08 84 17 80 	movl   $0x801784,0x8(%esp)
  800eb7:	00 
  800eb8:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ebf:	00 
  800ec0:	c7 04 24 a1 17 80 00 	movl   $0x8017a1,(%esp)
  800ec7:	e8 08 03 00 00       	call   8011d4 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800f0d:	00 
  800f0e:	c7 44 24 08 84 17 80 	movl   $0x801784,0x8(%esp)
  800f15:	00 
  800f16:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800f1d:	00 
  800f1e:	c7 04 24 a1 17 80 00 	movl   $0x8017a1,(%esp)
  800f25:	e8 aa 02 00 00       	call   8011d4 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800f6b:	00 
  800f6c:	c7 44 24 08 84 17 80 	movl   $0x801784,0x8(%esp)
  800f73:	00 
  800f74:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800f7b:	00 
  800f7c:	c7 04 24 a1 17 80 00 	movl   $0x8017a1,(%esp)
  800f83:	e8 4c 02 00 00       	call   8011d4 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800fc9:	00 
  800fca:	c7 44 24 08 84 17 80 	movl   $0x801784,0x8(%esp)
  800fd1:	00 
  800fd2:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800fd9:	00 
  800fda:	c7 04 24 a1 17 80 00 	movl   $0x8017a1,(%esp)
  800fe1:	e8 ee 01 00 00       	call   8011d4 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  80105a:	00 
  80105b:	c7 44 24 08 84 17 80 	movl   $0x801784,0x8(%esp)
  801062:	00 
  801063:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80106a:	00 
  80106b:	c7 04 24 a1 17 80 00 	movl   $0x8017a1,(%esp)
  801072:	e8 5d 01 00 00       	call   8011d4 <_panic>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  8010cb:	74 06                	je     8010d3 <ipc_recv+0x1b>
  8010cd:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
    if (perm_store) *perm_store = 0;
  8010d3:	85 f6                	test   %esi,%esi
  8010d5:	74 06                	je     8010dd <ipc_recv+0x25>
  ...
  8010ea:	e8 38 ff ff ff       	call   801027 <sys_ipc_recv>
    if (ret) return ret;
  8010ef:	85 c0                	test   %eax,%eax
  8010f1:	75 24                	jne    801117 <ipc_recv+0x5f>
    if (from_env_store)
  8010f3:	85 db                	test   %ebx,%ebx
  8010f5:	74 0a                	je     801101 <ipc_recv+0x49>
        *from_env_store = thisenv->env_ipc_from;
  8010f7:	a1 08 20 80 00       	mov    0x802008,%eax
  8010fc:	8b 40 74             	mov    0x74(%eax),%eax
  8010ff:	89 03                	mov    %eax,(%ebx)
    if (perm_store)
  801101:	85 f6                	test   %esi,%esi
  801103:	74 0a                	je     80110f <ipc_recv+0x57>
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  80113a:	eb 2a                	jmp    801166 <ipc_send+0x48>
    int ret;
    while ((ret = sys_ipc_try_send(to_env, val, pg, perm))) {
        if (ret == 0) break;
        if (ret != -E_IPC_NOT_RECV) panic("not E_IPC_NOT_RECV, %e", ret);
  80113c:	83 f8 f9             	cmp    $0xfffffff9,%eax
  80113f:	74 20                	je     801161 <ipc_send+0x43>
  801141:	89 44 24 0c          	mov    %eax,0xc(%esp)
  801145:	c7 44 24 08 af 17 80 	movl   $0x8017af,0x8(%esp)
  80114c:	00 
  80114d:	c7 44 24 04 36 00 00 	movl   $0x36,0x4(%esp)
  801154:	00 
  801155:	c7 04 24 c6 17 80 00 	movl   $0x8017c6,(%esp)
  80115c:	e8 73 00 00 00       	call   8011d4 <_panic>
        sys_yield();
  801161:	e8 86 fc ff ff       	call   800dec <sys_yield>
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
	// LAB 4: Your code here.
	if (!pg) pg = (void*)-1;
  ...
  801171:	89 7c 24 04          	mov    %edi,0x4(%esp)
  801175:	89 34 24             	mov    %esi,(%esp)
  801178:	e8 76 fe ff ff       	call   800ff3 <sys_ipc_try_send>
  80117d:	85 c0                	test   %eax,%eax
  80117f:	75 bb                	jne    80113c <ipc_send+0x1e>
        if (ret == 0) break;
        if (ret != -E_IPC_NOT_RECV) panic("not E_IPC_NOT_RECV, %e", ret);
        sys_yield();
    }
...
ipc_find_env(enum EnvType type)
{
  ...
  80118f:	a1 50 00 c0 ee       	mov    0xeec00050,%eax
  801194:	39 c8                	cmp    %ecx,%eax
  801196:	74 19                	je     8011b1 <ipc_find_env+0x28>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
  ...
  8011ad:	75 14                	jne    8011c3 <ipc_find_env+0x3a>
  8011af:	eb 05                	jmp    8011b6 <ipc_find_env+0x2d>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
  ...
  8011b9:	05 08 00 c0 ee       	add    $0xeec00008,%eax
  8011be:	8b 40 40             	mov    0x40(%eax),%eax
  8011c1:	eb 0e                	jmp    8011d1 <ipc_find_env+0x48>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
  ...
  8011cb:	75 d0                	jne    80119d <ipc_find_env+0x14>
		if (envs[i].env_type == type)
			return envs[i].env_id;
	return 0;
  8011cd:	66 b8 00 00          	mov    $0x0,%ax
}
  8011d1:	5d                   	pop    %ebp
  8011d2:	c3                   	ret    
	...
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8011e5:	e8 d2 fb ff ff       	call   800dbc <sys_getenvid>
  ...
  801200:	c7 04 24 d0 17 80 00 	movl   $0x8017d0,(%esp)
  801207:	e8 bf ef ff ff       	call   8001cb <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  80120c:	89 74 24 04          	mov    %esi,0x4(%esp)
  801210:	8b 45 10             	mov    0x10(%ebp),%eax
  801213:	89 04 24             	mov    %eax,(%esp)
  801216:	e8 4f ef ff ff       	call   80016a <vcprintf>
	cprintf("\n");
  80121b:	c7 04 24 ef 14 80 00 	movl   $0x8014ef,(%esp)
  801222:	e8 a4 ef ff ff       	call   8001cb <cprintf>
