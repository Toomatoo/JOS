...
sys_env_destroy(envid_t envid)
{
  ...
  80013a:	00 
  80013b:	c7 44 24 08 72 10 80 	movl   $0x801072,0x8(%esp)
  800142:	00 
  800143:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80014a:	00 
  80014b:	c7 04 24 8f 10 80 00 	movl   $0x80108f,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8001c0:	c7 04 24 a0 10 80 00 	movl   $0x8010a0,(%esp)
  ...
  8001d6:	e8 53 00 00 00       	call   80022e <vcprintf>
	cprintf("\n");
  8001db:	c7 04 24 c4 10 80 00 	movl   $0x8010c4,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800316:	e8 a5 0a 00 00       	call   800dc0 <__udivdi3>
  ...
  800369:	e8 82 0b 00 00       	call   800ef0 <__umoddi3>
  80036e:	89 7c 24 04          	mov    %edi,0x4(%esp)
  800372:	0f be 80 c6 10 80 00 	movsbl 0x8010c6(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80049a:	ff 24 85 6c 11 80 00 	jmp    *0x80116c(,%eax,4)
		case '6':
		case '7':
		case '8':
		case '9':
  ...
  800578:	c7 44 24 04 de 10 80 	movl   $0x8010de,0x4(%esp)
  80057f:	00 
  ...
  80059e:	c7 44 24 04 e2 10 80 	movl   $0x8010e2,0x4(%esp)
  8005a5:	00 
  ...
  8005c4:	c7 44 24 04 e6 10 80 	movl   $0x8010e6,0x4(%esp)
  8005cb:	00 
  ...
  8005ea:	c7 44 24 04 ea 10 80 	movl   $0x8010ea,0x4(%esp)
  8005f1:	00 
  ...
  800610:	c7 44 24 04 ee 10 80 	movl   $0x8010ee,0x4(%esp)
  800617:	00 
  ...
  800636:	c7 44 24 04 f2 10 80 	movl   $0x8010f2,0x4(%esp)
  80063d:	00 
  ...
  8006a8:	c7 44 24 08 ff 10 80 	movl   $0x8010ff,0x8(%esp)
  8006af:	00 
  ...
  8006dd:	b8 d7 10 80 00       	mov    $0x8010d7,%eax
