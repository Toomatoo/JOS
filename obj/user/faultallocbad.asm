...
handler(struct UTrapframe *utf)
{
  ...
  800044:	c7 04 24 a0 14 80 00 	movl   $0x8014a0,(%esp)
  ...
  80007b:	c7 44 24 08 c0 14 80 	movl   $0x8014c0,0x8(%esp)
  800082:	00 
  800083:	c7 44 24 04 0f 00 00 	movl   $0xf,0x4(%esp)
  80008a:	00 
  80008b:	c7 04 24 aa 14 80 00 	movl   $0x8014aa,(%esp)
  800092:	e8 b1 00 00 00       	call   800148 <_panic>
	snprintf((char*) addr, 100, "this string was faulted in at %x", addr);
  800097:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
  80009b:	c7 44 24 08 ec 14 80 	movl   $0x8014ec,0x8(%esp)
  8000a2:	00 
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800174:	c7 04 24 18 15 80 00 	movl   $0x801518,(%esp)
  ...
  80018a:	e8 53 00 00 00       	call   8001e2 <vcprintf>
	cprintf("\n");
  80018f:	c7 04 24 a8 14 80 00 	movl   $0x8014a8,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8002ca:	e8 11 0f 00 00       	call   8011e0 <__udivdi3>
  ...
  80031d:	e8 ee 0f 00 00       	call   801310 <__umoddi3>
  800322:	89 7c 24 04          	mov    %edi,0x4(%esp)
  800326:	0f be 80 3b 15 80 00 	movsbl 0x80153b(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80044e:	ff 24 85 20 16 80 00 	jmp    *0x801620(,%eax,4)
		case '6':
		case '7':
		case '8':
		case '9':
  ...
  80052c:	c7 44 24 04 53 15 80 	movl   $0x801553,0x4(%esp)
  800533:	00 
  ...
  800552:	c7 44 24 04 57 15 80 	movl   $0x801557,0x4(%esp)
  800559:	00 
  ...
  800578:	c7 44 24 04 5b 15 80 	movl   $0x80155b,0x4(%esp)
  80057f:	00 
  ...
  80059e:	c7 44 24 04 5f 15 80 	movl   $0x80155f,0x4(%esp)
  8005a5:	00 
  ...
  8005c4:	c7 44 24 04 63 15 80 	movl   $0x801563,0x4(%esp)
  8005cb:	00 
  ...
  8005ea:	c7 44 24 04 67 15 80 	movl   $0x801567,0x4(%esp)
  8005f1:	00 
  ...
  80065c:	c7 44 24 08 74 15 80 	movl   $0x801574,0x8(%esp)
  800663:	00 
  ...
  800691:	b8 4c 15 80 00       	mov    $0x80154c,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800e02:	00 
  800e03:	c7 44 24 08 a4 17 80 	movl   $0x8017a4,0x8(%esp)
  800e0a:	00 
  800e0b:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e12:	00 
  800e13:	c7 04 24 c1 17 80 00 	movl   $0x8017c1,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800ec1:	00 
  800ec2:	c7 44 24 08 a4 17 80 	movl   $0x8017a4,0x8(%esp)
  800ec9:	00 
  800eca:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ed1:	00 
  800ed2:	c7 04 24 c1 17 80 00 	movl   $0x8017c1,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800f1f:	00 
  800f20:	c7 44 24 08 a4 17 80 	movl   $0x8017a4,0x8(%esp)
  800f27:	00 
  800f28:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800f2f:	00 
  800f30:	c7 04 24 c1 17 80 00 	movl   $0x8017c1,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800f7d:	00 
  800f7e:	c7 44 24 08 a4 17 80 	movl   $0x8017a4,0x8(%esp)
  800f85:	00 
  800f86:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800f8d:	00 
  800f8e:	c7 04 24 c1 17 80 00 	movl   $0x8017c1,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800fdb:	00 
  800fdc:	c7 44 24 08 a4 17 80 	movl   $0x8017a4,0x8(%esp)
  800fe3:	00 
  800fe4:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800feb:	00 
  800fec:	c7 04 24 c1 17 80 00 	movl   $0x8017c1,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  801039:	00 
  80103a:	c7 44 24 08 a4 17 80 	movl   $0x8017a4,0x8(%esp)
  801041:	00 
  801042:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  801049:	00 
  80104a:	c7 04 24 c1 17 80 00 	movl   $0x8017c1,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  8010ca:	00 
  8010cb:	c7 44 24 08 a4 17 80 	movl   $0x8017a4,0x8(%esp)
  8010d2:	00 
  8010d3:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8010da:	00 
  8010db:	c7 04 24 c1 17 80 00 	movl   $0x8017c1,(%esp)
...
sys_change_pr(int pr)
{
  ...
  801100:	89 7d fc             	mov    %edi,-0x4(%ebp)
	...
	asm volatile("int %1\n"
  801103:	b9 00 00 00 00       	mov    $0x0,%ecx
  801108:	b8 0d 00 00 00       	mov    $0xd,%eax
  80110d:	8b 55 08             	mov    0x8(%ebp),%edx
  801110:	89 cb                	mov    %ecx,%ebx
  801112:	89 cf                	mov    %ecx,%edi
  801114:	89 ce                	mov    %ecx,%esi
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  801135:	75 3c                	jne    801173 <set_pgfault_handler+0x4b>
		// First time through!
  ...
  80114e:	e8 39 fd ff ff       	call   800e8c <sys_page_alloc>
  801153:	85 c0                	test   %eax,%eax
  801155:	79 1c                	jns    801173 <set_pgfault_handler+0x4b>
            panic("set_pgfault_handler:sys_page_alloc failed");
  801157:	c7 44 24 08 d0 17 80 	movl   $0x8017d0,0x8(%esp)
  80115e:	00 
  80115f:	c7 44 24 04 21 00 00 	movl   $0x21,0x4(%esp)
  801166:	00 
  801167:	c7 04 24 34 18 80 00 	movl   $0x801834,(%esp)
  80116e:	e8 d5 ef ff ff       	call   800148 <_panic>
	}

	// Save handler pointer for assembly to call.
	_pgfault_handler = handler;
  801173:	8b 45 08             	mov    0x8(%ebp),%eax
  801176:	a3 0c 20 80 00       	mov    %eax,0x80200c
	if (sys_env_set_pgfault_upcall(0, _pgfault_upcall) < 0)
  80117b:	c7 44 24 04 b4 11 80 	movl   $0x8011b4,0x4(%esp)
  801182:	00 
  801183:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  80118a:	e8 76 fe ff ff       	call   801005 <sys_env_set_pgfault_upcall>
  80118f:	85 c0                	test   %eax,%eax
  801191:	79 1c                	jns    8011af <set_pgfault_handler+0x87>
        panic("set_pgfault_handler:sys_env_set_pgfault_upcall failed");
  801193:	c7 44 24 08 fc 17 80 	movl   $0x8017fc,0x8(%esp)
  80119a:	00 
  80119b:	c7 44 24 04 27 00 00 	movl   $0x27,0x4(%esp)
  8011a2:	00 
  8011a3:	c7 04 24 34 18 80 00 	movl   $0x801834,(%esp)
  8011aa:	e8 99 ef ff ff       	call   800148 <_panic>
}
  8011af:	c9                   	leave  
  8011b0:	c3                   	ret    
...
_pgfault_upcall:
  ...
  8011b5:	a1 0c 20 80 00       	mov    0x80200c,%eax
	call *%eax
  ...
  8011bf:	8b 54 24 28          	mov    0x28(%esp),%edx
    subl $0x4, 0x30(%esp) # we have to use subl now because we can't use after popfl
  8011c3:	83 6c 24 30 04       	subl   $0x4,0x30(%esp)
    movl 0x30(%esp), %eax # trap-time esp-4
  8011c8:	8b 44 24 30          	mov    0x30(%esp),%eax
    movl %edx, (%eax)
