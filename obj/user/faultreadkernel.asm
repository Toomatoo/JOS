	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800226:	0f be 80 99 10 80 00 	movsbl 0x801099(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80034e:	ff 24 85 40 11 80 00 	jmp    *0x801140(,%eax,4)
		case '6':
		case '7':
		case '8':
		case '9':
  ...
  80042c:	c7 44 24 04 b1 10 80 	movl   $0x8010b1,0x4(%esp)
  800433:	00 
  ...
  800452:	c7 44 24 04 b5 10 80 	movl   $0x8010b5,0x4(%esp)
  800459:	00 
  ...
  800478:	c7 44 24 04 b9 10 80 	movl   $0x8010b9,0x4(%esp)
  80047f:	00 
  ...
  80049e:	c7 44 24 04 bd 10 80 	movl   $0x8010bd,0x4(%esp)
  8004a5:	00 
  ...
  8004c4:	c7 44 24 04 c1 10 80 	movl   $0x8010c1,0x4(%esp)
  8004cb:	00 
  ...
  8004ea:	c7 44 24 04 c5 10 80 	movl   $0x8010c5,0x4(%esp)
  8004f1:	00 
  ...
  80055c:	c7 44 24 08 d2 10 80 	movl   $0x8010d2,0x8(%esp)
  800563:	00 
  ...
  800591:	b8 aa 10 80 00       	mov    $0x8010aa,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800d02:	00 
  800d03:	c7 44 24 08 b4 12 80 	movl   $0x8012b4,0x8(%esp)
  800d0a:	00 
  800d0b:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d12:	00 
  800d13:	c7 04 24 d1 12 80 00 	movl   $0x8012d1,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800d88:	c7 04 24 e0 12 80 00 	movl   $0x8012e0,(%esp)
  ...
  800d9e:	e8 3f f3 ff ff       	call   8000e2 <vcprintf>
	cprintf("\n");
  800da3:	c7 04 24 04 13 80 00 	movl   $0x801304,(%esp)
