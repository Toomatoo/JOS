	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800246:	0f be 80 31 23 80 00 	movsbl 0x802331(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80044c:	c7 44 24 04 49 23 80 	movl   $0x802349,0x4(%esp)
  800453:	00 
  ...
  800472:	c7 44 24 04 4d 23 80 	movl   $0x80234d,0x4(%esp)
  800479:	00 
  ...
  800498:	c7 44 24 04 51 23 80 	movl   $0x802351,0x4(%esp)
  80049f:	00 
  ...
  8004be:	c7 44 24 04 55 23 80 	movl   $0x802355,0x4(%esp)
  8004c5:	00 
  ...
  8004e4:	c7 44 24 04 59 23 80 	movl   $0x802359,0x4(%esp)
  8004eb:	00 
  ...
  80050a:	c7 44 24 04 5d 23 80 	movl   $0x80235d,0x4(%esp)
  800511:	00 
  ...
  800559:	c7 44 24 08 61 23 80 	movl   $0x802361,0x8(%esp)
  800560:	00 
  ...
  8005b1:	b8 42 23 80 00       	mov    $0x802342,%eax
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801ee2:	e8 1b e2 ff ff       	call   800102 <vcprintf>
	cprintf("\n");
  801ee7:	c7 04 24 43 27 80 00 	movl   $0x802743,(%esp)
