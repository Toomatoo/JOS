	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800242:	0f be 80 b9 10 80 00 	movsbl 0x8010b9(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80036a:	ff 24 85 60 11 80 00 	jmp    *0x801160(,%eax,4)
		case '6':
		case '7':
		case '8':
		case '9':
  ...
  800448:	c7 44 24 04 d1 10 80 	movl   $0x8010d1,0x4(%esp)
  80044f:	00 
  ...
  80046e:	c7 44 24 04 d5 10 80 	movl   $0x8010d5,0x4(%esp)
  800475:	00 
  ...
  800494:	c7 44 24 04 d9 10 80 	movl   $0x8010d9,0x4(%esp)
  80049b:	00 
  ...
  8004ba:	c7 44 24 04 dd 10 80 	movl   $0x8010dd,0x4(%esp)
  8004c1:	00 
  ...
  8004e0:	c7 44 24 04 e1 10 80 	movl   $0x8010e1,0x4(%esp)
  8004e7:	00 
  ...
  800506:	c7 44 24 04 e5 10 80 	movl   $0x8010e5,0x4(%esp)
  80050d:	00 
  ...
  800578:	c7 44 24 08 f2 10 80 	movl   $0x8010f2,0x8(%esp)
  80057f:	00 
  ...
  8005ad:	b8 ca 10 80 00       	mov    $0x8010ca,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800d22:	00 
  800d23:	c7 44 24 08 d4 12 80 	movl   $0x8012d4,0x8(%esp)
  800d2a:	00 
  800d2b:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d32:	00 
  800d33:	c7 04 24 f1 12 80 00 	movl   $0x8012f1,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800da8:	c7 04 24 00 13 80 00 	movl   $0x801300,(%esp)
  ...
  800dbe:	e8 3b f3 ff ff       	call   8000fe <vcprintf>
	cprintf("\n");
  800dc3:	c7 04 24 24 13 80 00 	movl   $0x801324,(%esp)
