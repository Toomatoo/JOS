...
umain(int argc, char **argv)
{
  ...
  800037:	83 ec 08             	sub    $0x8,%esp
	binaryname = "idle";
  80003a:	c7 05 00 30 80 00 00 	movl   $0x802300,0x803000
  800041:	23 80 00 
...
exit(void)
{
  ...
  80009f:	83 ec 18             	sub    $0x18,%esp
	close_all();
  8000a2:	e8 47 06 00 00       	call   8006ee <close_all>
	sys_env_destroy(0);
...
sys_env_destroy(envid_t envid)
{
  ...
  80014a:	00 
  80014b:	c7 44 24 08 0f 23 80 	movl   $0x80230f,0x8(%esp)
  800152:	00 
  800153:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80015a:	00 
  80015b:	c7 04 24 2c 23 80 00 	movl   $0x80232c,(%esp)
  800162:	e8 59 11 00 00       	call   8012c0 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800209:	00 
  80020a:	c7 44 24 08 0f 23 80 	movl   $0x80230f,0x8(%esp)
  800211:	00 
  800212:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800219:	00 
  80021a:	c7 04 24 2c 23 80 00 	movl   $0x80232c,(%esp)
  800221:	e8 9a 10 00 00       	call   8012c0 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800267:	00 
  800268:	c7 44 24 08 0f 23 80 	movl   $0x80230f,0x8(%esp)
  80026f:	00 
  800270:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800277:	00 
  800278:	c7 04 24 2c 23 80 00 	movl   $0x80232c,(%esp)
  80027f:	e8 3c 10 00 00       	call   8012c0 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  8002c5:	00 
  8002c6:	c7 44 24 08 0f 23 80 	movl   $0x80230f,0x8(%esp)
  8002cd:	00 
  8002ce:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8002d5:	00 
  8002d6:	c7 04 24 2c 23 80 00 	movl   $0x80232c,(%esp)
  8002dd:	e8 de 0f 00 00       	call   8012c0 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800323:	00 
  800324:	c7 44 24 08 0f 23 80 	movl   $0x80230f,0x8(%esp)
  80032b:	00 
  80032c:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800333:	00 
  800334:	c7 04 24 2c 23 80 00 	movl   $0x80232c,(%esp)
  80033b:	e8 80 0f 00 00       	call   8012c0 <_panic>
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800381:	00 
  800382:	c7 44 24 08 0f 23 80 	movl   $0x80230f,0x8(%esp)
  800389:	00 
  80038a:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800391:	00 
  800392:	c7 04 24 2c 23 80 00 	movl   $0x80232c,(%esp)
  800399:	e8 22 0f 00 00       	call   8012c0 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  8003df:	00 
  8003e0:	c7 44 24 08 0f 23 80 	movl   $0x80230f,0x8(%esp)
  8003e7:	00 
  8003e8:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8003ef:	00 
  8003f0:	c7 04 24 2c 23 80 00 	movl   $0x80232c,(%esp)
  8003f7:	e8 c4 0e 00 00       	call   8012c0 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800470:	00 
  800471:	c7 44 24 08 0f 23 80 	movl   $0x80230f,0x8(%esp)
  800478:	00 
  800479:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800480:	00 
  800481:	c7 04 24 2c 23 80 00 	movl   $0x80232c,(%esp)
  800488:	e8 33 0e 00 00       	call   8012c0 <_panic>
...
sys_change_pr(int pr)
{
  ...
  8004a0:	89 5d f4             	mov    %ebx,-0xc(%ebp)
  8004a3:	89 75 f8             	mov    %esi,-0x8(%ebp)
  8004a6:	89 7d fc             	mov    %edi,-0x4(%ebp)
	//
	// The last clause tells the assembler that this can
	// potentially change the condition codes and arbitrary
	// memory locations.
  ...
  8004ae:	b8 0e 00 00 00       	mov    $0xe,%eax
...
sys_change_pr(int pr)
{
  ...
  8004be:	8b 5d f4             	mov    -0xc(%ebp),%ebx
  8004c1:	8b 75 f8             	mov    -0x8(%ebp),%esi
  8004c4:	8b 7d fc             	mov    -0x4(%ebp),%edi
  8004c7:	89 ec                	mov    %ebp,%esp
  8004c9:	5d                   	pop    %ebp
  8004ca:	c3                   	ret    
  8004cb:	00 00                	add    %al,(%eax)
  8004cd:	00 00                	add    %al,(%eax)
	...
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  8005f3:	8b 14 85 b8 23 80 00 	mov    0x8023b8(,%eax,4),%edx
  ...
  80060e:	c7 04 24 3c 23 80 00 	movl   $0x80233c,(%esp)
...
fd_close(struct Fd *fd, bool must_exist)
{
  ...
  8006a9:	e8 e3 fb ff ff       	call   800291 <sys_page_unmap>
	return r;
}
...
dup(int oldfdnum, int newfdnum)
{
  ...
  8007b2:	e8 7c fa ff ff       	call   800233 <sys_page_map>
  ...
  8007ed:	e8 41 fa ff ff       	call   800233 <sys_page_map>
...
//cprintf("Read in\n");
  ...
  800881:	c7 04 24 7d 23 80 00 	movl   $0x80237d,(%esp)
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  80095c:	c7 04 24 99 23 80 00 	movl   $0x802399,(%esp)
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  800a13:	c7 04 24 5c 23 80 00 	movl   $0x80235c,(%esp)
...
//cprintf("devfile_read: into\n");
  ...
  800c2d:	c7 44 24 0c c8 23 80 	movl   $0x8023c8,0xc(%esp)
  800c34:	00 
  800c35:	c7 44 24 08 cf 23 80 	movl   $0x8023cf,0x8(%esp)
  800c3c:	00 
  800c3d:	c7 44 24 04 7b 00 00 	movl   $0x7b,0x4(%esp)
  800c44:	00 
  800c45:	c7 04 24 e4 23 80 00 	movl   $0x8023e4,(%esp)
  800c4c:	e8 6f 06 00 00       	call   8012c0 <_panic>
	assert(r <= PGSIZE);
  800c51:	3d 00 10 00 00       	cmp    $0x1000,%eax
  800c56:	7e 24                	jle    800c7c <devfile_read+0x84>
  800c58:	c7 44 24 0c ef 23 80 	movl   $0x8023ef,0xc(%esp)
  800c5f:	00 
  800c60:	c7 44 24 08 cf 23 80 	movl   $0x8023cf,0x8(%esp)
  800c67:	00 
  800c68:	c7 44 24 04 7c 00 00 	movl   $0x7c,0x4(%esp)
  800c6f:	00 
  800c70:	c7 04 24 e4 23 80 00 	movl   $0x8023e4,(%esp)
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800d4c:	c7 44 24 04 fb 23 80 	movl   $0x8023fb,0x4(%esp)
  800d53:	00 
...
devpipe_close(struct Fd *fd)
{
  ...
  800d9f:	e8 ed f4 ff ff       	call   800291 <sys_page_unmap>
  ...
  800db7:	e8 d5 f4 ff ff       	call   800291 <sys_page_unmap>
}
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  800e1e:	c7 04 24 02 24 80 00 	movl   $0x802402,(%esp)
...
devpipe_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  800e5a:	75 53                	jne    800eaf <devpipe_write+0x83>
			...
			sys_yield();
  800e5c:	e8 43 f3 ff ff       	call   8001a4 <sys_yield>
		cprintf("[%08x] devpipe_write %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
//cprintf("devpipe_read: p_rpos=%d, p_wpos=%d\n", p->p_rpos, p->p_wpos);
			sys_yield();
  800ef9:	e8 a6 f2 ff ff       	call   8001a4 <sys_yield>
		cprintf("[%08x] devpipe_read %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
pipe(int pfd[2])
{
  ...
  800f91:	e8 3e f2 ff ff       	call   8001d4 <sys_page_alloc>
  ...
  800fcb:	e8 04 f2 ff ff       	call   8001d4 <sys_page_alloc>
  ...
  800ffa:	e8 d5 f1 ff ff       	call   8001d4 <sys_page_alloc>
  ...
  801033:	e8 fb f1 ff ff       	call   800233 <sys_page_map>
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801120:	c7 44 24 04 1a 24 80 	movl   $0x80241a,0x4(%esp)
  801127:	00 
...
devcons_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  801186:	e8 2d ef ff ff       	call   8000b8 <sys_cputs>
	int tot, m;
	char buf[128];
...
devcons_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  8011b2:	eb 31                	jmp    8011e5 <devcons_read+0x44>
	...
	while ((c = sys_cgetc()) == 0)
		sys_yield();
  8011b4:	e8 eb ef ff ff       	call   8001a4 <sys_yield>
	int c;
  ...
  8011c0:	e8 22 ef ff ff       	call   8000e7 <sys_cgetc>
...
cputchar(int ch)
{
  ...
  801201:	e8 b2 ee ff ff       	call   8000b8 <sys_cputs>
}
  801206:	c9                   	leave  
  801207:	c3                   	ret    
...
opencons(void)
{
  ...
  801298:	e8 37 ef ff ff       	call   8001d4 <sys_page_alloc>
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8012d1:	e8 9e ee ff ff       	call   800174 <sys_getenvid>
  ...
  8012ec:	c7 04 24 28 24 80 00 	movl   $0x802428,(%esp)
  ...
  801302:	e8 53 00 00 00       	call   80135a <vcprintf>
	cprintf("\n");
  801307:	c7 04 24 13 24 80 00 	movl   $0x802413,(%esp)
...
putch(int ch, struct printbuf *b)
{
  ...
  801345:	e8 6e ed ff ff       	call   8000b8 <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  8013ae:	e8 05 ed ff ff       	call   8000b8 <sys_cputs>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80149e:	0f be 80 4b 24 80 00 	movsbl 0x80244b(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8016a4:	c7 44 24 04 63 24 80 	movl   $0x802463,0x4(%esp)
  8016ab:	00 
  ...
  8016ca:	c7 44 24 04 67 24 80 	movl   $0x802467,0x4(%esp)
  8016d1:	00 
  ...
  8016f0:	c7 44 24 04 6b 24 80 	movl   $0x80246b,0x4(%esp)
  8016f7:	00 
  ...
  801716:	c7 44 24 04 6f 24 80 	movl   $0x80246f,0x4(%esp)
  80171d:	00 
  ...
  80173c:	c7 44 24 04 73 24 80 	movl   $0x802473,0x4(%esp)
  801743:	00 
  ...
  801762:	c7 44 24 04 77 24 80 	movl   $0x802477,0x4(%esp)
  801769:	00 
  ...
  8017b1:	c7 44 24 08 7b 24 80 	movl   $0x80247b,0x8(%esp)
  8017b8:	00 
  ...
  8017d4:	c7 44 24 08 e1 23 80 	movl   $0x8023e1,0x8(%esp)
  8017db:	00 
  ...
  801809:	b8 5c 24 80 00       	mov    $0x80245c,%eax
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801f22:	e8 16 e5 ff ff       	call   80043d <sys_ipc_recv>
    if (ret) return ret;
...
//cprintf("ipc_send: sys_yield\n");
        sys_yield();
  801f99:	e8 06 e2 ff ff       	call   8001a4 <sys_yield>
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
	// LAB 4: Your code here.
	if (!pg) pg = (void*)-1;
  ...
  801fb0:	e8 54 e4 ff ff       	call   800409 <sys_ipc_try_send>
