...
umain(int argc, char **argv)
{
  ...
  800037:	83 ec 18             	sub    $0x18,%esp
	cprintf("hello, world\n");
  80003a:	c7 04 24 60 13 80 00 	movl   $0x801360,(%esp)
  ...
  800052:	c7 04 24 6e 13 80 00 	movl   $0x80136e,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8001ee:	e8 bd 0e 00 00       	call   8010b0 <__udivdi3>
  ...
  800241:	e8 9a 0f 00 00       	call   8011e0 <__umoddi3>
  800246:	89 7c 24 04          	mov    %edi,0x4(%esp)
  80024a:	0f be 80 8f 13 80 00 	movsbl 0x80138f(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800372:	ff 24 85 60 14 80 00 	jmp    *0x801460(,%eax,4)
		case '6':
		case '7':
		case '8':
		case '9':
  ...
  800450:	c7 44 24 04 a7 13 80 	movl   $0x8013a7,0x4(%esp)
  800457:	00 
  ...
  800476:	c7 44 24 04 ab 13 80 	movl   $0x8013ab,0x4(%esp)
  80047d:	00 
  ...
  80049c:	c7 44 24 04 af 13 80 	movl   $0x8013af,0x4(%esp)
  8004a3:	00 
  ...
  8004c2:	c7 44 24 04 b3 13 80 	movl   $0x8013b3,0x4(%esp)
  8004c9:	00 
  ...
  8004e8:	c7 44 24 04 b7 13 80 	movl   $0x8013b7,0x4(%esp)
  8004ef:	00 
  ...
  80050e:	c7 44 24 04 bb 13 80 	movl   $0x8013bb,0x4(%esp)
  800515:	00 
  ...
  800580:	c7 44 24 08 c8 13 80 	movl   $0x8013c8,0x8(%esp)
  800587:	00 
  ...
  8005b5:	b8 a0 13 80 00       	mov    $0x8013a0,%eax
