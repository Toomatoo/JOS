...
umain(int argc, char **argv)
{
  ...
  80003a:	c7 44 24 04 dc 04 80 	movl   $0x8004dc,0x4(%esp)
  800041:	00 
...
exit(void)
{
  ...
  8000af:	83 ec 18             	sub    $0x18,%esp
	close_all();
  8000b2:	e8 67 06 00 00       	call   80071e <close_all>
	sys_env_destroy(0);
...
sys_env_destroy(envid_t envid)
{
  ...
  80015a:	00 
  80015b:	c7 44 24 08 ca 23 80 	movl   $0x8023ca,0x8(%esp)
  800162:	00 
  800163:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80016a:	00 
  80016b:	c7 04 24 e7 23 80 00 	movl   $0x8023e7,(%esp)
  800172:	e8 79 11 00 00       	call   8012f0 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800219:	00 
  80021a:	c7 44 24 08 ca 23 80 	movl   $0x8023ca,0x8(%esp)
  800221:	00 
  800222:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800229:	00 
  80022a:	c7 04 24 e7 23 80 00 	movl   $0x8023e7,(%esp)
  800231:	e8 ba 10 00 00       	call   8012f0 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800277:	00 
  800278:	c7 44 24 08 ca 23 80 	movl   $0x8023ca,0x8(%esp)
  80027f:	00 
  800280:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800287:	00 
  800288:	c7 04 24 e7 23 80 00 	movl   $0x8023e7,(%esp)
  80028f:	e8 5c 10 00 00       	call   8012f0 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  8002d5:	00 
  8002d6:	c7 44 24 08 ca 23 80 	movl   $0x8023ca,0x8(%esp)
  8002dd:	00 
  8002de:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8002e5:	00 
  8002e6:	c7 04 24 e7 23 80 00 	movl   $0x8023e7,(%esp)
  8002ed:	e8 fe 0f 00 00       	call   8012f0 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800333:	00 
  800334:	c7 44 24 08 ca 23 80 	movl   $0x8023ca,0x8(%esp)
  80033b:	00 
  80033c:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800343:	00 
  800344:	c7 04 24 e7 23 80 00 	movl   $0x8023e7,(%esp)
  80034b:	e8 a0 0f 00 00       	call   8012f0 <_panic>
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800391:	00 
  800392:	c7 44 24 08 ca 23 80 	movl   $0x8023ca,0x8(%esp)
  800399:	00 
  80039a:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8003a1:	00 
  8003a2:	c7 04 24 e7 23 80 00 	movl   $0x8023e7,(%esp)
  8003a9:	e8 42 0f 00 00       	call   8012f0 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  8003ef:	00 
  8003f0:	c7 44 24 08 ca 23 80 	movl   $0x8023ca,0x8(%esp)
  8003f7:	00 
  8003f8:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8003ff:	00 
  800400:	c7 04 24 e7 23 80 00 	movl   $0x8023e7,(%esp)
  800407:	e8 e4 0e 00 00       	call   8012f0 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800480:	00 
  800481:	c7 44 24 08 ca 23 80 	movl   $0x8023ca,0x8(%esp)
  800488:	00 
  800489:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800490:	00 
  800491:	c7 04 24 e7 23 80 00 	movl   $0x8023e7,(%esp)
  800498:	e8 53 0e 00 00       	call   8012f0 <_panic>
...
sys_change_pr(int pr)
{
  ...
  8004b0:	89 5d f4             	mov    %ebx,-0xc(%ebp)
  8004b3:	89 75 f8             	mov    %esi,-0x8(%ebp)
  8004b6:	89 7d fc             	mov    %edi,-0x4(%ebp)
	//
	// The last clause tells the assembler that this can
	// potentially change the condition codes and arbitrary
	// memory locations.
  ...
  8004be:	b8 0e 00 00 00       	mov    $0xe,%eax
...
sys_change_pr(int pr)
{
  ...
  8004ce:	8b 5d f4             	mov    -0xc(%ebp),%ebx
  8004d1:	8b 75 f8             	mov    -0x8(%ebp),%esi
  8004d4:	8b 7d fc             	mov    -0x4(%ebp),%edi
  8004d7:	89 ec                	mov    %ebp,%esp
  8004d9:	5d                   	pop    %ebp
  8004da:	c3                   	ret    
	...

008004dc <_pgfault_upcall>:
...
_pgfault_upcall:
  ...
  8004dd:	a1 00 60 80 00       	mov    0x806000,%eax
	call *%eax
  ...
  8004e7:	8b 54 24 28          	mov    0x28(%esp),%edx
    subl $0x4, 0x30(%esp) # we have to use subl now because we can't use after popfl
  8004eb:	83 6c 24 30 04       	subl   $0x4,0x30(%esp)
    movl 0x30(%esp), %eax # trap-time esp-4
  8004f0:	8b 44 24 30          	mov    0x30(%esp),%eax
    movl %edx, (%eax)
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800623:	8b 14 85 74 24 80 00 	mov    0x802474(,%eax,4),%edx
  ...
  80063e:	c7 04 24 f8 23 80 00 	movl   $0x8023f8,(%esp)
...
fd_close(struct Fd *fd, bool must_exist)
{
  ...
  8006d9:	e8 c3 fb ff ff       	call   8002a1 <sys_page_unmap>
	return r;
}
...
dup(int oldfdnum, int newfdnum)
{
  ...
  8007e2:	e8 5c fa ff ff       	call   800243 <sys_page_map>
  ...
  80081d:	e8 21 fa ff ff       	call   800243 <sys_page_map>
...
//cprintf("Read in\n");
  ...
  8008b1:	c7 04 24 39 24 80 00 	movl   $0x802439,(%esp)
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  80098c:	c7 04 24 55 24 80 00 	movl   $0x802455,(%esp)
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  800a43:	c7 04 24 18 24 80 00 	movl   $0x802418,(%esp)
...
fsipc(unsigned type, void *dstva)
{
  ...
  800b60:	e8 18 15 00 00       	call   80207d <ipc_find_env>
  ...
  800b86:	e8 87 14 00 00       	call   802012 <ipc_send>
//cprintf("fsipc: ipc_recv\n");
  ...
  800b9e:	e8 09 14 00 00       	call   801fac <ipc_recv>
}
...
//cprintf("devfile_read: into\n");
  ...
  800c5d:	c7 44 24 0c 84 24 80 	movl   $0x802484,0xc(%esp)
  800c64:	00 
  800c65:	c7 44 24 08 8b 24 80 	movl   $0x80248b,0x8(%esp)
  800c6c:	00 
  800c6d:	c7 44 24 04 7b 00 00 	movl   $0x7b,0x4(%esp)
  800c74:	00 
  800c75:	c7 04 24 a0 24 80 00 	movl   $0x8024a0,(%esp)
  800c7c:	e8 6f 06 00 00       	call   8012f0 <_panic>
	assert(r <= PGSIZE);
  800c81:	3d 00 10 00 00       	cmp    $0x1000,%eax
  800c86:	7e 24                	jle    800cac <devfile_read+0x84>
  800c88:	c7 44 24 0c ab 24 80 	movl   $0x8024ab,0xc(%esp)
  800c8f:	00 
  800c90:	c7 44 24 08 8b 24 80 	movl   $0x80248b,0x8(%esp)
  800c97:	00 
  800c98:	c7 44 24 04 7c 00 00 	movl   $0x7c,0x4(%esp)
  800c9f:	00 
  800ca0:	c7 04 24 a0 24 80 00 	movl   $0x8024a0,(%esp)
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800d7c:	c7 44 24 04 b7 24 80 	movl   $0x8024b7,0x4(%esp)
  800d83:	00 
...
devpipe_close(struct Fd *fd)
{
  ...
  800dcf:	e8 cd f4 ff ff       	call   8002a1 <sys_page_unmap>
  ...
  800de7:	e8 b5 f4 ff ff       	call   8002a1 <sys_page_unmap>
}
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  800e4e:	c7 04 24 be 24 80 00 	movl   $0x8024be,(%esp)
...
devpipe_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  800e8a:	75 53                	jne    800edf <devpipe_write+0x83>
			...
			sys_yield();
  800e8c:	e8 23 f3 ff ff       	call   8001b4 <sys_yield>
		cprintf("[%08x] devpipe_write %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
//cprintf("devpipe_read: p_rpos=%d, p_wpos=%d\n", p->p_rpos, p->p_wpos);
			sys_yield();
  800f29:	e8 86 f2 ff ff       	call   8001b4 <sys_yield>
		cprintf("[%08x] devpipe_read %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
pipe(int pfd[2])
{
  ...
  800fc1:	e8 1e f2 ff ff       	call   8001e4 <sys_page_alloc>
  ...
  800ffb:	e8 e4 f1 ff ff       	call   8001e4 <sys_page_alloc>
  ...
  80102a:	e8 b5 f1 ff ff       	call   8001e4 <sys_page_alloc>
  ...
  801063:	e8 db f1 ff ff       	call   800243 <sys_page_map>
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801150:	c7 44 24 04 d6 24 80 	movl   $0x8024d6,0x4(%esp)
  801157:	00 
...
devcons_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  8011b6:	e8 0d ef ff ff       	call   8000c8 <sys_cputs>
	int tot, m;
	char buf[128];
...
devcons_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  8011e2:	eb 31                	jmp    801215 <devcons_read+0x44>
	...
	while ((c = sys_cgetc()) == 0)
		sys_yield();
  8011e4:	e8 cb ef ff ff       	call   8001b4 <sys_yield>
	int c;
  ...
  8011f0:	e8 02 ef ff ff       	call   8000f7 <sys_cgetc>
...
cputchar(int ch)
{
  ...
  801231:	e8 92 ee ff ff       	call   8000c8 <sys_cputs>
}
  801236:	c9                   	leave  
  801237:	c3                   	ret    
...
opencons(void)
{
  ...
  8012c8:	e8 17 ef ff ff       	call   8001e4 <sys_page_alloc>
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801301:	e8 7e ee ff ff       	call   800184 <sys_getenvid>
  ...
  80131c:	c7 04 24 e4 24 80 00 	movl   $0x8024e4,(%esp)
  ...
  801332:	e8 53 00 00 00       	call   80138a <vcprintf>
	cprintf("\n");
  801337:	c7 04 24 cf 24 80 00 	movl   $0x8024cf,(%esp)
...
putch(int ch, struct printbuf *b)
{
  ...
  801375:	e8 4e ed ff ff       	call   8000c8 <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  8013de:	e8 e5 ec ff ff       	call   8000c8 <sys_cputs>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  801472:	e8 99 0c 00 00       	call   802110 <__udivdi3>
  ...
  8014c5:	e8 76 0d 00 00       	call   802240 <__umoddi3>
  8014ca:	89 7c 24 04          	mov    %edi,0x4(%esp)
  8014ce:	0f be 80 07 25 80 00 	movsbl 0x802507(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8015f6:	ff 24 85 60 26 80 00 	jmp    *0x802660(,%eax,4)
		case '6':
		case '7':
		case '8':
		case '9':
  ...
  8016d4:	c7 44 24 04 1f 25 80 	movl   $0x80251f,0x4(%esp)
  8016db:	00 
  ...
  8016fa:	c7 44 24 04 23 25 80 	movl   $0x802523,0x4(%esp)
  801701:	00 
  ...
  801720:	c7 44 24 04 27 25 80 	movl   $0x802527,0x4(%esp)
  801727:	00 
  ...
  801746:	c7 44 24 04 2b 25 80 	movl   $0x80252b,0x4(%esp)
  80174d:	00 
  ...
  80176c:	c7 44 24 04 2f 25 80 	movl   $0x80252f,0x4(%esp)
  801773:	00 
  ...
  801792:	c7 44 24 04 33 25 80 	movl   $0x802533,0x4(%esp)
  801799:	00 
  ...
  801804:	c7 44 24 08 9d 24 80 	movl   $0x80249d,0x8(%esp)
  80180b:	00 
  ...
  801839:	b8 18 25 80 00       	mov    $0x802518,%eax
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  801f2d:	75 3c                	jne    801f6b <set_pgfault_handler+0x4b>
		// First time through!
		// LAB 4: Your code here.
		if (sys_page_alloc(0, (void*)(UXSTACKTOP-PGSIZE), PTE_W|PTE_U|PTE_P) < 0) 
  801f2f:	c7 44 24 08 07 00 00 	movl   $0x7,0x8(%esp)
  801f36:	00 
  801f37:	c7 44 24 04 00 f0 bf 	movl   $0xeebff000,0x4(%esp)
  801f3e:	ee 
  801f3f:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  801f46:	e8 99 e2 ff ff       	call   8001e4 <sys_page_alloc>
  801f4b:	85 c0                	test   %eax,%eax
  801f4d:	79 1c                	jns    801f6b <set_pgfault_handler+0x4b>
            panic("set_pgfault_handler:sys_page_alloc failed");
  801f4f:	c7 44 24 08 20 28 80 	movl   $0x802820,0x8(%esp)
  801f56:	00 
  801f57:	c7 44 24 04 21 00 00 	movl   $0x21,0x4(%esp)
  801f5e:	00 
  801f5f:	c7 04 24 84 28 80 00 	movl   $0x802884,(%esp)
  801f66:	e8 85 f3 ff ff       	call   8012f0 <_panic>
	}
  ...
  801f73:	c7 44 24 04 dc 04 80 	movl   $0x8004dc,0x4(%esp)
  801f7a:	00 
  801f7b:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  801f82:	e8 34 e4 ff ff       	call   8003bb <sys_env_set_pgfault_upcall>
  801f87:	85 c0                	test   %eax,%eax
  801f89:	79 1c                	jns    801fa7 <set_pgfault_handler+0x87>
        panic("set_pgfault_handler:sys_env_set_pgfault_upcall failed");
  801f8b:	c7 44 24 08 4c 28 80 	movl   $0x80284c,0x8(%esp)
  801f92:	00 
  801f93:	c7 44 24 04 27 00 00 	movl   $0x27,0x4(%esp)
  801f9a:	00 
  801f9b:	c7 04 24 84 28 80 00 	movl   $0x802884,(%esp)
  801fa2:	e8 49 f3 ff ff       	call   8012f0 <_panic>
}
  801fa7:	c9                   	leave  
  801fa8:	c3                   	ret    
  801fa9:	00 00                	add    %al,(%eax)
	...
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801fba:	8b 75 10             	mov    0x10(%ebp),%esi
	// LAB 4: Your code here.
	if (from_env_store) *from_env_store = 0;
  801fbd:	85 db                	test   %ebx,%ebx
  801fbf:	74 06                	je     801fc7 <ipc_recv+0x1b>
  801fc1:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
    if (perm_store) *perm_store = 0;
  801fc7:	85 f6                	test   %esi,%esi
  801fc9:	74 06                	je     801fd1 <ipc_recv+0x25>
  801fcb:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
    if (!pg) pg = (void*) -1;
  801fd1:	85 c0                	test   %eax,%eax
  801fd3:	ba ff ff ff ff       	mov    $0xffffffff,%edx
  801fd8:	0f 44 c2             	cmove  %edx,%eax
    int ret = sys_ipc_recv(pg);
  801fdb:	89 04 24             	mov    %eax,(%esp)
  801fde:	e8 6a e4 ff ff       	call   80044d <sys_ipc_recv>
    if (ret) return ret;
  801fe3:	85 c0                	test   %eax,%eax
  801fe5:	75 24                	jne    80200b <ipc_recv+0x5f>
    if (from_env_store)
  801fe7:	85 db                	test   %ebx,%ebx
  801fe9:	74 0a                	je     801ff5 <ipc_recv+0x49>
        *from_env_store = thisenv->env_ipc_from;
  801feb:	a1 04 40 80 00       	mov    0x804004,%eax
  801ff0:	8b 40 74             	mov    0x74(%eax),%eax
  801ff3:	89 03                	mov    %eax,(%ebx)
    if (perm_store)
  801ff5:	85 f6                	test   %esi,%esi
  801ff7:	74 0a                	je     802003 <ipc_recv+0x57>
        *perm_store = thisenv->env_ipc_perm;
  801ff9:	a1 04 40 80 00       	mov    0x804004,%eax
  801ffe:	8b 40 78             	mov    0x78(%eax),%eax
  802001:	89 06                	mov    %eax,(%esi)
//cprintf("ipc_recv: return\n");
    return thisenv->env_ipc_value;
  802003:	a1 04 40 80 00       	mov    0x804004,%eax
  802008:	8b 40 70             	mov    0x70(%eax),%eax
}
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  802026:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  80202b:	0f 44 d8             	cmove  %eax,%ebx
  80202e:	eb 2a                	jmp    80205a <ipc_send+0x48>
    int ret;
    while ((ret = sys_ipc_try_send(to_env, val, pg, perm))) {
//cprintf("ipc_send: loop\n");
        if (ret == 0) break;
        if (ret != -E_IPC_NOT_RECV) panic("not E_IPC_NOT_RECV, %e", ret);
  802030:	83 f8 f9             	cmp    $0xfffffff9,%eax
  802033:	74 20                	je     802055 <ipc_send+0x43>
  802035:	89 44 24 0c          	mov    %eax,0xc(%esp)
  802039:	c7 44 24 08 92 28 80 	movl   $0x802892,0x8(%esp)
  802040:	00 
  802041:	c7 44 24 04 39 00 00 	movl   $0x39,0x4(%esp)
  802048:	00 
  802049:	c7 04 24 a9 28 80 00 	movl   $0x8028a9,(%esp)
  802050:	e8 9b f2 ff ff       	call   8012f0 <_panic>
//cprintf("ipc_send: sys_yield\n");
        sys_yield();
  802055:	e8 5a e1 ff ff       	call   8001b4 <sys_yield>
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
	// LAB 4: Your code here.
	if (!pg) pg = (void*)-1;
  ...
  80205d:	89 44 24 0c          	mov    %eax,0xc(%esp)
  802061:	89 5c 24 08          	mov    %ebx,0x8(%esp)
  802065:	89 7c 24 04          	mov    %edi,0x4(%esp)
  802069:	89 34 24             	mov    %esi,(%esp)
  80206c:	e8 a8 e3 ff ff       	call   800419 <sys_ipc_try_send>
  802071:	85 c0                	test   %eax,%eax
  802073:	75 bb                	jne    802030 <ipc_send+0x1e>
        if (ret == 0) break;
        if (ret != -E_IPC_NOT_RECV) panic("not E_IPC_NOT_RECV, %e", ret);
//cprintf("ipc_send: sys_yield\n");
        sys_yield();
...
ipc_find_env(enum EnvType type)
{
  ...
  802083:	a1 50 00 c0 ee       	mov    0xeec00050,%eax
  802088:	39 c8                	cmp    %ecx,%eax
  80208a:	74 19                	je     8020a5 <ipc_find_env+0x28>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
  ...
  802096:	81 c2 00 00 c0 ee    	add    $0xeec00000,%edx
  80209c:	8b 52 50             	mov    0x50(%edx),%edx
  80209f:	39 ca                	cmp    %ecx,%edx
  8020a1:	75 14                	jne    8020b7 <ipc_find_env+0x3a>
  8020a3:	eb 05                	jmp    8020aa <ipc_find_env+0x2d>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
  ...
  8020aa:	c1 e0 07             	shl    $0x7,%eax
  8020ad:	05 08 00 c0 ee       	add    $0xeec00008,%eax
  8020b2:	8b 40 40             	mov    0x40(%eax),%eax
  8020b5:	eb 0e                	jmp    8020c5 <ipc_find_env+0x48>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
  ...
  8020bf:	75 d0                	jne    802091 <ipc_find_env+0x14>
		if (envs[i].env_type == type)
			return envs[i].env_id;
	return 0;
  8020c1:	66 b8 00 00          	mov    $0x0,%ax
}
  8020c5:	5d                   	pop    %ebp
  8020c6:	c3                   	ret    
	...
...
pageref(void *v)
{
  ...
  8020d3:	8b 0c 85 00 d0 7b ef 	mov    -0x10843000(,%eax,4),%ecx
		return 0;
...
pageref(void *v)
{
  ...
  8020e2:	74 1d                	je     802101 <pageref+0x39>
		return 0;
	pte = uvpt[PGNUM(v)];
  8020e4:	c1 ea 0c             	shr    $0xc,%edx
  8020e7:	8b 14 95 00 00 40 ef 	mov    -0x10c00000(,%edx,4),%edx
	if (!(pte & PTE_P))
  8020ee:	f6 c2 01             	test   $0x1,%dl
  8020f1:	74 0e                	je     802101 <pageref+0x39>
		return 0;
	return pages[PGNUM(pte)].pp_ref;
  8020f3:	c1 ea 0c             	shr    $0xc,%edx
  8020f6:	0f b7 04 d5 04 00 00 	movzwl -0x10fffffc(,%edx,8),%eax
  8020fd:	ef 
  8020fe:	0f b7 c0             	movzwl %ax,%eax
}
  802101:	5d                   	pop    %ebp
  802102:	c3                   	ret    
	...
...
00802110 <__udivdi3>:
  ...
  802113:	89 7c 24 14          	mov    %edi,0x14(%esp)
  802117:	8b 7c 24 2c          	mov    0x2c(%esp),%edi
  80211b:	8b 44 24 20          	mov    0x20(%esp),%eax
  80211f:	8b 4c 24 28          	mov    0x28(%esp),%ecx
  802123:	89 74 24 10          	mov    %esi,0x10(%esp)
  802127:	8b 74 24 24          	mov    0x24(%esp),%esi
  80212b:	85 ff                	test   %edi,%edi
  80212d:	89 6c 24 18          	mov    %ebp,0x18(%esp)
  802131:	89 44 24 08          	mov    %eax,0x8(%esp)
  802135:	89 cd                	mov    %ecx,%ebp
  802137:	89 44 24 04          	mov    %eax,0x4(%esp)
  80213b:	75 33                	jne    802170 <__udivdi3+0x60>
  80213d:	39 f1                	cmp    %esi,%ecx
  80213f:	77 57                	ja     802198 <__udivdi3+0x88>
  802141:	85 c9                	test   %ecx,%ecx
  802143:	75 0b                	jne    802150 <__udivdi3+0x40>
  ...
  802154:	f7 f1                	div    %ecx
  802156:	89 c6                	mov    %eax,%esi
  802158:	8b 44 24 04          	mov    0x4(%esp),%eax
  80215c:	f7 f1                	div    %ecx
  80215e:	89 f2                	mov    %esi,%edx
  802160:	8b 74 24 10          	mov    0x10(%esp),%esi
  802164:	8b 7c 24 14          	mov    0x14(%esp),%edi
  802168:	8b 6c 24 18          	mov    0x18(%esp),%ebp
  80216c:	83 c4 1c             	add    $0x1c,%esp
  80216f:	c3                   	ret    
  802170:	31 d2                	xor    %edx,%edx
  802172:	31 c0                	xor    %eax,%eax
  802174:	39 f7                	cmp    %esi,%edi
  802176:	77 e8                	ja     802160 <__udivdi3+0x50>
  802178:	0f bd cf             	bsr    %edi,%ecx
  80217b:	83 f1 1f             	xor    $0x1f,%ecx
  80217e:	89 4c 24 04          	mov    %ecx,0x4(%esp)
  802182:	75 2c                	jne    8021b0 <__udivdi3+0xa0>
  802184:	3b 6c 24 08          	cmp    0x8(%esp),%ebp
  802188:	76 04                	jbe    80218e <__udivdi3+0x7e>
  80218a:	39 f7                	cmp    %esi,%edi
  80218c:	73 d2                	jae    802160 <__udivdi3+0x50>
  80218e:	31 d2                	xor    %edx,%edx
  802190:	b8 01 00 00 00       	mov    $0x1,%eax
  802195:	eb c9                	jmp    802160 <__udivdi3+0x50>
  802197:	90                   	nop
  802198:	89 f2                	mov    %esi,%edx
  80219a:	f7 f1                	div    %ecx
  80219c:	31 d2                	xor    %edx,%edx
  80219e:	8b 74 24 10          	mov    0x10(%esp),%esi
  8021a2:	8b 7c 24 14          	mov    0x14(%esp),%edi
  8021a6:	8b 6c 24 18          	mov    0x18(%esp),%ebp
  8021aa:	83 c4 1c             	add    $0x1c,%esp
  8021ad:	c3                   	ret    
  8021ae:	66 90                	xchg   %ax,%ax
  8021b0:	0f b6 4c 24 04       	movzbl 0x4(%esp),%ecx
  8021b5:	b8 20 00 00 00       	mov    $0x20,%eax
  8021ba:	89 ea                	mov    %ebp,%edx
  8021bc:	2b 44 24 04          	sub    0x4(%esp),%eax
  8021c0:	d3 e7                	shl    %cl,%edi
  8021c2:	89 c1                	mov    %eax,%ecx
  8021c4:	d3 ea                	shr    %cl,%edx
  8021c6:	0f b6 4c 24 04       	movzbl 0x4(%esp),%ecx
  8021cb:	09 fa                	or     %edi,%edx
  8021cd:	89 f7                	mov    %esi,%edi
  8021cf:	89 54 24 0c          	mov    %edx,0xc(%esp)
  8021d3:	89 f2                	mov    %esi,%edx
  8021d5:	8b 74 24 08          	mov    0x8(%esp),%esi
  8021d9:	d3 e5                	shl    %cl,%ebp
  8021db:	89 c1                	mov    %eax,%ecx
  8021dd:	d3 ef                	shr    %cl,%edi
  8021df:	0f b6 4c 24 04       	movzbl 0x4(%esp),%ecx
  8021e4:	d3 e2                	shl    %cl,%edx
  8021e6:	89 c1                	mov    %eax,%ecx
  8021e8:	d3 ee                	shr    %cl,%esi
  8021ea:	09 d6                	or     %edx,%esi
  8021ec:	89 fa                	mov    %edi,%edx
  8021ee:	89 f0                	mov    %esi,%eax
  8021f0:	f7 74 24 0c          	divl   0xc(%esp)
  8021f4:	89 d7                	mov    %edx,%edi
  8021f6:	89 c6                	mov    %eax,%esi
  8021f8:	f7 e5                	mul    %ebp
  8021fa:	39 d7                	cmp    %edx,%edi
  8021fc:	72 22                	jb     802220 <__udivdi3+0x110>
  8021fe:	8b 6c 24 08          	mov    0x8(%esp),%ebp
  802202:	0f b6 4c 24 04       	movzbl 0x4(%esp),%ecx
  802207:	d3 e5                	shl    %cl,%ebp
  802209:	39 c5                	cmp    %eax,%ebp
  80220b:	73 04                	jae    802211 <__udivdi3+0x101>
  80220d:	39 d7                	cmp    %edx,%edi
  80220f:	74 0f                	je     802220 <__udivdi3+0x110>
  802211:	89 f0                	mov    %esi,%eax
  802213:	31 d2                	xor    %edx,%edx
  802215:	e9 46 ff ff ff       	jmp    802160 <__udivdi3+0x50>
  80221a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  802220:	8d 46 ff             	lea    -0x1(%esi),%eax
  802223:	31 d2                	xor    %edx,%edx
  802225:	8b 74 24 10          	mov    0x10(%esp),%esi
  802229:	8b 7c 24 14          	mov    0x14(%esp),%edi
  80222d:	8b 6c 24 18          	mov    0x18(%esp),%ebp
...
00802240 <__umoddi3>:
  ...
  802243:	89 6c 24 18          	mov    %ebp,0x18(%esp)
  802247:	8b 6c 24 2c          	mov    0x2c(%esp),%ebp
  80224b:	8b 44 24 20          	mov    0x20(%esp),%eax
  80224f:	89 74 24 10          	mov    %esi,0x10(%esp)
  802253:	8b 4c 24 28          	mov    0x28(%esp),%ecx
  802257:	8b 74 24 24          	mov    0x24(%esp),%esi
  80225b:	85 ed                	test   %ebp,%ebp
  80225d:	89 7c 24 14          	mov    %edi,0x14(%esp)
  802261:	89 44 24 08          	mov    %eax,0x8(%esp)
  802265:	89 cf                	mov    %ecx,%edi
  802267:	89 04 24             	mov    %eax,(%esp)
  80226a:	89 f2                	mov    %esi,%edx
  80226c:	75 1a                	jne    802288 <__umoddi3+0x48>
  80226e:	39 f1                	cmp    %esi,%ecx
  802270:	76 4e                	jbe    8022c0 <__umoddi3+0x80>
  802272:	f7 f1                	div    %ecx
  802274:	89 d0                	mov    %edx,%eax
  802276:	31 d2                	xor    %edx,%edx
  802278:	8b 74 24 10          	mov    0x10(%esp),%esi
  80227c:	8b 7c 24 14          	mov    0x14(%esp),%edi
  802280:	8b 6c 24 18          	mov    0x18(%esp),%ebp
  802284:	83 c4 1c             	add    $0x1c,%esp
  802287:	c3                   	ret    
  802288:	39 f5                	cmp    %esi,%ebp
  80228a:	77 54                	ja     8022e0 <__umoddi3+0xa0>
  80228c:	0f bd c5             	bsr    %ebp,%eax
  80228f:	83 f0 1f             	xor    $0x1f,%eax
  802292:	89 44 24 04          	mov    %eax,0x4(%esp)
  802296:	75 60                	jne    8022f8 <__umoddi3+0xb8>
  802298:	3b 0c 24             	cmp    (%esp),%ecx
  80229b:	0f 87 07 01 00 00    	ja     8023a8 <__umoddi3+0x168>
  8022a1:	89 f2                	mov    %esi,%edx
  8022a3:	8b 34 24             	mov    (%esp),%esi
  8022a6:	29 ce                	sub    %ecx,%esi
  8022a8:	19 ea                	sbb    %ebp,%edx
  8022aa:	89 34 24             	mov    %esi,(%esp)
  8022ad:	8b 04 24             	mov    (%esp),%eax
  8022b0:	8b 74 24 10          	mov    0x10(%esp),%esi
  8022b4:	8b 7c 24 14          	mov    0x14(%esp),%edi
  8022b8:	8b 6c 24 18          	mov    0x18(%esp),%ebp
  8022bc:	83 c4 1c             	add    $0x1c,%esp
  8022bf:	c3                   	ret    
  8022c0:	85 c9                	test   %ecx,%ecx
  8022c2:	75 0b                	jne    8022cf <__umoddi3+0x8f>
  ...
  8022d5:	8b 04 24             	mov    (%esp),%eax
  8022d8:	f7 f1                	div    %ecx
  8022da:	eb 98                	jmp    802274 <__umoddi3+0x34>
  8022dc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  8022e0:	89 f2                	mov    %esi,%edx
  8022e2:	8b 74 24 10          	mov    0x10(%esp),%esi
  8022e6:	8b 7c 24 14          	mov    0x14(%esp),%edi
  8022ea:	8b 6c 24 18          	mov    0x18(%esp),%ebp
  8022ee:	83 c4 1c             	add    $0x1c,%esp
  8022f1:	c3                   	ret    
  8022f2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  8022f8:	0f b6 4c 24 04       	movzbl 0x4(%esp),%ecx
  8022fd:	89 e8                	mov    %ebp,%eax
  8022ff:	bd 20 00 00 00       	mov    $0x20,%ebp
  802304:	2b 6c 24 04          	sub    0x4(%esp),%ebp
  802308:	89 fa                	mov    %edi,%edx
  80230a:	d3 e0                	shl    %cl,%eax
  80230c:	89 e9                	mov    %ebp,%ecx
  80230e:	d3 ea                	shr    %cl,%edx
  802310:	0f b6 4c 24 04       	movzbl 0x4(%esp),%ecx
  802315:	09 c2                	or     %eax,%edx
  ...
  802335:	0f b6 4c 24 04       	movzbl 0x4(%esp),%ecx
  80233a:	09 f0                	or     %esi,%eax
  80233c:	8b 74 24 08          	mov    0x8(%esp),%esi
  802340:	f7 34 24             	divl   (%esp)
  802343:	d3 e6                	shl    %cl,%esi
  802345:	89 74 24 08          	mov    %esi,0x8(%esp)
  802349:	89 d6                	mov    %edx,%esi
  80234b:	f7 e7                	mul    %edi
  80234d:	39 d6                	cmp    %edx,%esi
  80234f:	89 c1                	mov    %eax,%ecx
  802351:	89 d7                	mov    %edx,%edi
  802353:	72 3f                	jb     802394 <__umoddi3+0x154>
  802355:	39 44 24 08          	cmp    %eax,0x8(%esp)
  802359:	72 35                	jb     802390 <__umoddi3+0x150>
  80235b:	8b 44 24 08          	mov    0x8(%esp),%eax
  80235f:	29 c8                	sub    %ecx,%eax
  802361:	19 fe                	sbb    %edi,%esi
  802363:	0f b6 4c 24 04       	movzbl 0x4(%esp),%ecx
  802368:	89 f2                	mov    %esi,%edx
  80236a:	d3 e8                	shr    %cl,%eax
  80236c:	89 e9                	mov    %ebp,%ecx
  80236e:	d3 e2                	shl    %cl,%edx
  802370:	0f b6 4c 24 04       	movzbl 0x4(%esp),%ecx
  802375:	09 d0                	or     %edx,%eax
  802377:	89 f2                	mov    %esi,%edx
  802379:	d3 ea                	shr    %cl,%edx
  80237b:	8b 74 24 10          	mov    0x10(%esp),%esi
  80237f:	8b 7c 24 14          	mov    0x14(%esp),%edi
  802383:	8b 6c 24 18          	mov    0x18(%esp),%ebp
  802387:	83 c4 1c             	add    $0x1c,%esp
  80238a:	c3                   	ret    
  80238b:	90                   	nop
  80238c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  802390:	39 d6                	cmp    %edx,%esi
  802392:	75 c7                	jne    80235b <__umoddi3+0x11b>
  802394:	89 d7                	mov    %edx,%edi
  802396:	89 c1                	mov    %eax,%ecx
  802398:	2b 4c 24 0c          	sub    0xc(%esp),%ecx
  80239c:	1b 3c 24             	sbb    (%esp),%edi
  80239f:	eb ba                	jmp    80235b <__umoddi3+0x11b>
  8023a1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  8023a8:	39 f5                	cmp    %esi,%ebp
  8023aa:	0f 82 f1 fe ff ff    	jb     8022a1 <__umoddi3+0x61>
  8023b0:	e9 f8 fe ff ff       	jmp    8022ad <__umoddi3+0x6d>
