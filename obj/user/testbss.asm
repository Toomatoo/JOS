...
umain(int argc, char **argv)
{
  ...
  80003a:	c7 04 24 20 14 80 00 	movl   $0x801420,(%esp)
...
umain(int argc, char **argv)
{
  ...
  800069:	c7 44 24 08 9b 14 80 	movl   $0x80149b,0x8(%esp)
  800070:	00 
  800071:	c7 44 24 04 12 00 00 	movl   $0x12,0x4(%esp)
  800078:	00 
  800079:	c7 04 24 b8 14 80 00 	movl   $0x8014b8,(%esp)
...
umain(int argc, char **argv)
{
  ...
  8000c7:	c7 44 24 08 40 14 80 	movl   $0x801440,0x8(%esp)
  8000ce:	00 
  8000cf:	c7 44 24 04 18 00 00 	movl   $0x18,0x4(%esp)
  8000d6:	00 
  8000d7:	c7 04 24 b8 14 80 00 	movl   $0x8014b8,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8001b0:	c7 04 24 e8 14 80 00 	movl   $0x8014e8,(%esp)
  ...
  8001c6:	e8 53 00 00 00       	call   80021e <vcprintf>
	cprintf("\n");
  8001cb:	c7 04 24 b6 14 80 00 	movl   $0x8014b6,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800306:	e8 65 0e 00 00       	call   801170 <__udivdi3>
  ...
  800359:	e8 42 0f 00 00       	call   8012a0 <__umoddi3>
  80035e:	89 7c 24 04          	mov    %edi,0x4(%esp)
  800362:	0f be 80 0c 15 80 00 	movsbl 0x80150c(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80048a:	ff 24 85 e0 15 80 00 	jmp    *0x8015e0(,%eax,4)
		case '6':
		case '7':
		case '8':
		case '9':
  ...
  800568:	c7 44 24 04 24 15 80 	movl   $0x801524,0x4(%esp)
  80056f:	00 
  ...
  80058e:	c7 44 24 04 28 15 80 	movl   $0x801528,0x4(%esp)
  800595:	00 
  ...
  8005b4:	c7 44 24 04 2c 15 80 	movl   $0x80152c,0x4(%esp)
  8005bb:	00 
  ...
  8005da:	c7 44 24 04 30 15 80 	movl   $0x801530,0x4(%esp)
  8005e1:	00 
  ...
  800600:	c7 44 24 04 34 15 80 	movl   $0x801534,0x4(%esp)
  800607:	00 
  ...
  800626:	c7 44 24 04 38 15 80 	movl   $0x801538,0x4(%esp)
  80062d:	00 
  ...
  800698:	c7 44 24 08 45 15 80 	movl   $0x801545,0x8(%esp)
  80069f:	00 
  ...
  8006cd:	b8 1d 15 80 00       	mov    $0x80151d,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800e42:	00 
  800e43:	c7 44 24 08 64 17 80 	movl   $0x801764,0x8(%esp)
  800e4a:	00 
  800e4b:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e52:	00 
  800e53:	c7 04 24 81 17 80 00 	movl   $0x801781,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800f01:	00 
  800f02:	c7 44 24 08 64 17 80 	movl   $0x801764,0x8(%esp)
  800f09:	00 
  800f0a:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800f11:	00 
  800f12:	c7 04 24 81 17 80 00 	movl   $0x801781,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800f5f:	00 
  800f60:	c7 44 24 08 64 17 80 	movl   $0x801764,0x8(%esp)
  800f67:	00 
  800f68:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800f6f:	00 
  800f70:	c7 04 24 81 17 80 00 	movl   $0x801781,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800fbd:	00 
  800fbe:	c7 44 24 08 64 17 80 	movl   $0x801764,0x8(%esp)
  800fc5:	00 
  800fc6:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800fcd:	00 
  800fce:	c7 04 24 81 17 80 00 	movl   $0x801781,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  80101b:	00 
  80101c:	c7 44 24 08 64 17 80 	movl   $0x801764,0x8(%esp)
  801023:	00 
  801024:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80102b:	00 
  80102c:	c7 04 24 81 17 80 00 	movl   $0x801781,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  801079:	00 
  80107a:	c7 44 24 08 64 17 80 	movl   $0x801764,0x8(%esp)
  801081:	00 
  801082:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  801089:	00 
  80108a:	c7 04 24 81 17 80 00 	movl   $0x801781,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  80110a:	00 
  80110b:	c7 44 24 08 64 17 80 	movl   $0x801764,0x8(%esp)
  801112:	00 
  801113:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80111a:	00 
  80111b:	c7 04 24 81 17 80 00 	movl   $0x801781,(%esp)
