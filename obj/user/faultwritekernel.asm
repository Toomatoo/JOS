...
exit(void)
{
  ...
  800097:	83 ec 18             	sub    $0x18,%esp
	close_all();
  80009a:	e8 4f 06 00 00       	call   8006ee <close_all>
	sys_env_destroy(0);
...
sys_env_destroy(envid_t envid)
{
  ...
  800142:	00 
  800143:	c7 44 24 08 0a 23 80 	movl   $0x80230a,0x8(%esp)
  80014a:	00 
  80014b:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800152:	00 
  800153:	c7 04 24 27 23 80 00 	movl   $0x802327,(%esp)
  80015a:	e8 61 11 00 00       	call   8012c0 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800201:	00 
  800202:	c7 44 24 08 0a 23 80 	movl   $0x80230a,0x8(%esp)
  800209:	00 
  80020a:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800211:	00 
  800212:	c7 04 24 27 23 80 00 	movl   $0x802327,(%esp)
  800219:	e8 a2 10 00 00       	call   8012c0 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  80025f:	00 
  800260:	c7 44 24 08 0a 23 80 	movl   $0x80230a,0x8(%esp)
  800267:	00 
  800268:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80026f:	00 
  800270:	c7 04 24 27 23 80 00 	movl   $0x802327,(%esp)
  800277:	e8 44 10 00 00       	call   8012c0 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  8002bd:	00 
  8002be:	c7 44 24 08 0a 23 80 	movl   $0x80230a,0x8(%esp)
  8002c5:	00 
  8002c6:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8002cd:	00 
  8002ce:	c7 04 24 27 23 80 00 	movl   $0x802327,(%esp)
  8002d5:	e8 e6 0f 00 00       	call   8012c0 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  80031b:	00 
  80031c:	c7 44 24 08 0a 23 80 	movl   $0x80230a,0x8(%esp)
  800323:	00 
  800324:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80032b:	00 
  80032c:	c7 04 24 27 23 80 00 	movl   $0x802327,(%esp)
  800333:	e8 88 0f 00 00       	call   8012c0 <_panic>
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800379:	00 
  80037a:	c7 44 24 08 0a 23 80 	movl   $0x80230a,0x8(%esp)
  800381:	00 
  800382:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800389:	00 
  80038a:	c7 04 24 27 23 80 00 	movl   $0x802327,(%esp)
  800391:	e8 2a 0f 00 00       	call   8012c0 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  8003d7:	00 
  8003d8:	c7 44 24 08 0a 23 80 	movl   $0x80230a,0x8(%esp)
  8003df:	00 
  8003e0:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8003e7:	00 
  8003e8:	c7 04 24 27 23 80 00 	movl   $0x802327,(%esp)
  8003ef:	e8 cc 0e 00 00       	call   8012c0 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800468:	00 
  800469:	c7 44 24 08 0a 23 80 	movl   $0x80230a,0x8(%esp)
  800470:	00 
  800471:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800478:	00 
  800479:	c7 04 24 27 23 80 00 	movl   $0x802327,(%esp)
  800480:	e8 3b 0e 00 00       	call   8012c0 <_panic>
...
sys_change_pr(int pr)
{
  ...
  800498:	89 5d f4             	mov    %ebx,-0xc(%ebp)
  80049b:	89 75 f8             	mov    %esi,-0x8(%ebp)
...
sys_change_pr(int pr)
{
  ...
  8004b6:	8b 5d f4             	mov    -0xc(%ebp),%ebx
  8004b9:	8b 75 f8             	mov    -0x8(%ebp),%esi
  8004bc:	8b 7d fc             	mov    -0x4(%ebp),%edi
  8004bf:	89 ec                	mov    %ebp,%esp
  8004c1:	5d                   	pop    %ebp
  8004c2:	c3                   	ret    
	...
...
fd_close(struct Fd *fd, bool must_exist)
{
  ...
  8006a9:	e8 db fb ff ff       	call   800289 <sys_page_unmap>
	return r;
}
...
dup(int oldfdnum, int newfdnum)
{
  ...
  8007b2:	e8 74 fa ff ff       	call   80022b <sys_page_map>
  ...
  8007ed:	e8 39 fa ff ff       	call   80022b <sys_page_map>
...
devpipe_close(struct Fd *fd)
{
  ...
  800d9f:	e8 e5 f4 ff ff       	call   800289 <sys_page_unmap>
  ...
  800db7:	e8 cd f4 ff ff       	call   800289 <sys_page_unmap>
}
...
devpipe_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  800e5a:	75 53                	jne    800eaf <devpipe_write+0x83>
			...
			sys_yield();
  800e5c:	e8 3b f3 ff ff       	call   80019c <sys_yield>
		cprintf("[%08x] devpipe_write %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
//cprintf("devpipe_read: p_rpos=%d, p_wpos=%d\n", p->p_rpos, p->p_wpos);
			sys_yield();
  800ef9:	e8 9e f2 ff ff       	call   80019c <sys_yield>
		cprintf("[%08x] devpipe_read %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
pipe(int pfd[2])
{
  ...
  800f91:	e8 36 f2 ff ff       	call   8001cc <sys_page_alloc>
  ...
  800fcb:	e8 fc f1 ff ff       	call   8001cc <sys_page_alloc>
  ...
  800ffa:	e8 cd f1 ff ff       	call   8001cc <sys_page_alloc>
  ...
  801033:	e8 f3 f1 ff ff       	call   80022b <sys_page_map>
...
devcons_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  801186:	e8 25 ef ff ff       	call   8000b0 <sys_cputs>
	int tot, m;
	char buf[128];
...
devcons_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  8011b2:	eb 31                	jmp    8011e5 <devcons_read+0x44>
	...
	while ((c = sys_cgetc()) == 0)
		sys_yield();
  8011b4:	e8 e3 ef ff ff       	call   80019c <sys_yield>
	int c;
  ...
  8011c0:	e8 1a ef ff ff       	call   8000df <sys_cgetc>
...
cputchar(int ch)
{
  ...
  801201:	e8 aa ee ff ff       	call   8000b0 <sys_cputs>
}
  801206:	c9                   	leave  
  801207:	c3                   	ret    
...
opencons(void)
{
  ...
  801298:	e8 2f ef ff ff       	call   8001cc <sys_page_alloc>
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8012d1:	e8 96 ee ff ff       	call   80016c <sys_getenvid>
...
putch(int ch, struct printbuf *b)
{
  ...
  801345:	e8 66 ed ff ff       	call   8000b0 <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  8013ae:	e8 fd ec ff ff       	call   8000b0 <sys_cputs>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801f22:	e8 0e e5 ff ff       	call   800435 <sys_ipc_recv>
    if (ret) return ret;
...
//cprintf("ipc_send: sys_yield\n");
        sys_yield();
  801f99:	e8 fe e1 ff ff       	call   80019c <sys_yield>
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
	// LAB 4: Your code here.
	if (!pg) pg = (void*)-1;
  ...
  801fb0:	e8 4c e4 ff ff       	call   800401 <sys_ipc_try_send>
