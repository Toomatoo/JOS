...
sys_env_destroy(envid_t envid)
{
  ...
  80013a:	00 
  80013b:	c7 44 24 08 4a 13 80 	movl   $0x80134a,0x8(%esp)
  800142:	00 
  800143:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80014a:	00 
  80014b:	c7 04 24 67 13 80 00 	movl   $0x801367,(%esp)
  800152:	e8 09 03 00 00       	call   800460 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  8001f9:	00 
  8001fa:	c7 44 24 08 4a 13 80 	movl   $0x80134a,0x8(%esp)
  800201:	00 
  800202:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800209:	00 
  80020a:	c7 04 24 67 13 80 00 	movl   $0x801367,(%esp)
  800211:	e8 4a 02 00 00       	call   800460 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800257:	00 
  800258:	c7 44 24 08 4a 13 80 	movl   $0x80134a,0x8(%esp)
  80025f:	00 
  800260:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800267:	00 
  800268:	c7 04 24 67 13 80 00 	movl   $0x801367,(%esp)
  80026f:	e8 ec 01 00 00       	call   800460 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  8002b5:	00 
  8002b6:	c7 44 24 08 4a 13 80 	movl   $0x80134a,0x8(%esp)
  8002bd:	00 
  8002be:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8002c5:	00 
  8002c6:	c7 04 24 67 13 80 00 	movl   $0x801367,(%esp)
  8002cd:	e8 8e 01 00 00       	call   800460 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800313:	00 
  800314:	c7 44 24 08 4a 13 80 	movl   $0x80134a,0x8(%esp)
  80031b:	00 
  80031c:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800323:	00 
  800324:	c7 04 24 67 13 80 00 	movl   $0x801367,(%esp)
  80032b:	e8 30 01 00 00       	call   800460 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800371:	00 
  800372:	c7 44 24 08 4a 13 80 	movl   $0x80134a,0x8(%esp)
  800379:	00 
  80037a:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800381:	00 
  800382:	c7 04 24 67 13 80 00 	movl   $0x801367,(%esp)
  800389:	e8 d2 00 00 00       	call   800460 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800402:	00 
  800403:	c7 44 24 08 4a 13 80 	movl   $0x80134a,0x8(%esp)
  80040a:	00 
  80040b:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800412:	00 
  800413:	c7 04 24 67 13 80 00 	movl   $0x801367,(%esp)
  80041a:	e8 41 00 00 00       	call   800460 <_panic>
...
sys_change_pr(int pr)
{
  ...
  800432:	89 5d f4             	mov    %ebx,-0xc(%ebp)
  800435:	89 75 f8             	mov    %esi,-0x8(%ebp)
  800438:	89 7d fc             	mov    %edi,-0x4(%ebp)
	//
	// The last clause tells the assembler that this can
	// potentially change the condition codes and arbitrary
	// memory locations.
  ...
  800440:	b8 0d 00 00 00       	mov    $0xd,%eax
...
sys_change_pr(int pr)
{
  ...
  800450:	8b 5d f4             	mov    -0xc(%ebp),%ebx
  800453:	8b 75 f8             	mov    -0x8(%ebp),%esi
  800456:	8b 7d fc             	mov    -0x4(%ebp),%edi
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800471:	e8 ee fc ff ff       	call   800164 <sys_getenvid>
...
putch(int ch, struct printbuf *b)
{
  ...
  8004e5:	e8 be fb ff ff       	call   8000a8 <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  80054e:	e8 55 fb ff ff       	call   8000a8 <sys_cputs>
