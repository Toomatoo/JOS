...
exit(void)
{
  ...
  80008f:	83 ec 18             	sub    $0x18,%esp
	close_all();
  800092:	e8 47 06 00 00       	call   8006de <close_all>
	sys_env_destroy(0);
...
sys_env_destroy(envid_t envid)
{
  ...
  80013a:	00 
  80013b:	c7 44 24 08 0a 23 80 	movl   $0x80230a,0x8(%esp)
  800142:	00 
  800143:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80014a:	00 
  80014b:	c7 04 24 27 23 80 00 	movl   $0x802327,(%esp)
  800152:	e8 59 11 00 00       	call   8012b0 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  8001f9:	00 
  8001fa:	c7 44 24 08 0a 23 80 	movl   $0x80230a,0x8(%esp)
  800201:	00 
  800202:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800209:	00 
  80020a:	c7 04 24 27 23 80 00 	movl   $0x802327,(%esp)
  800211:	e8 9a 10 00 00       	call   8012b0 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800257:	00 
  800258:	c7 44 24 08 0a 23 80 	movl   $0x80230a,0x8(%esp)
  80025f:	00 
  800260:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800267:	00 
  800268:	c7 04 24 27 23 80 00 	movl   $0x802327,(%esp)
  80026f:	e8 3c 10 00 00       	call   8012b0 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  8002b5:	00 
  8002b6:	c7 44 24 08 0a 23 80 	movl   $0x80230a,0x8(%esp)
  8002bd:	00 
  8002be:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8002c5:	00 
  8002c6:	c7 04 24 27 23 80 00 	movl   $0x802327,(%esp)
  8002cd:	e8 de 0f 00 00       	call   8012b0 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800313:	00 
  800314:	c7 44 24 08 0a 23 80 	movl   $0x80230a,0x8(%esp)
  80031b:	00 
  80031c:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800323:	00 
  800324:	c7 04 24 27 23 80 00 	movl   $0x802327,(%esp)
  80032b:	e8 80 0f 00 00       	call   8012b0 <_panic>
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800371:	00 
  800372:	c7 44 24 08 0a 23 80 	movl   $0x80230a,0x8(%esp)
  800379:	00 
  80037a:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800381:	00 
  800382:	c7 04 24 27 23 80 00 	movl   $0x802327,(%esp)
  800389:	e8 22 0f 00 00       	call   8012b0 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  8003cf:	00 
  8003d0:	c7 44 24 08 0a 23 80 	movl   $0x80230a,0x8(%esp)
  8003d7:	00 
  8003d8:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8003df:	00 
  8003e0:	c7 04 24 27 23 80 00 	movl   $0x802327,(%esp)
  8003e7:	e8 c4 0e 00 00       	call   8012b0 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800460:	00 
  800461:	c7 44 24 08 0a 23 80 	movl   $0x80230a,0x8(%esp)
  800468:	00 
  800469:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800470:	00 
  800471:	c7 04 24 27 23 80 00 	movl   $0x802327,(%esp)
  800478:	e8 33 0e 00 00       	call   8012b0 <_panic>
...
sys_change_pr(int pr)
{
  ...
  800490:	89 5d f4             	mov    %ebx,-0xc(%ebp)
  800493:	89 75 f8             	mov    %esi,-0x8(%ebp)
...
sys_change_pr(int pr)
{
  ...
  8004ae:	8b 5d f4             	mov    -0xc(%ebp),%ebx
  8004b1:	8b 75 f8             	mov    -0x8(%ebp),%esi
  8004b4:	8b 7d fc             	mov    -0x4(%ebp),%edi
  8004b7:	89 ec                	mov    %ebp,%esp
  8004b9:	5d                   	pop    %ebp
  8004ba:	c3                   	ret    
  8004bb:	00 00                	add    %al,(%eax)
...
fd_close(struct Fd *fd, bool must_exist)
{
  ...
  800699:	e8 e3 fb ff ff       	call   800281 <sys_page_unmap>
	return r;
}
...
dup(int oldfdnum, int newfdnum)
{
  ...
  8007a2:	e8 7c fa ff ff       	call   800223 <sys_page_map>
  ...
  8007dd:	e8 41 fa ff ff       	call   800223 <sys_page_map>
...
devpipe_close(struct Fd *fd)
{
  ...
  800d8f:	e8 ed f4 ff ff       	call   800281 <sys_page_unmap>
  ...
  800da7:	e8 d5 f4 ff ff       	call   800281 <sys_page_unmap>
}
...
devpipe_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  800e4a:	75 53                	jne    800e9f <devpipe_write+0x83>
			...
			sys_yield();
  800e4c:	e8 43 f3 ff ff       	call   800194 <sys_yield>
		cprintf("[%08x] devpipe_write %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
//cprintf("devpipe_read: p_rpos=%d, p_wpos=%d\n", p->p_rpos, p->p_wpos);
			sys_yield();
  800ee9:	e8 a6 f2 ff ff       	call   800194 <sys_yield>
		cprintf("[%08x] devpipe_read %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
pipe(int pfd[2])
{
  ...
  800f81:	e8 3e f2 ff ff       	call   8001c4 <sys_page_alloc>
  ...
  800fbb:	e8 04 f2 ff ff       	call   8001c4 <sys_page_alloc>
  ...
  800fea:	e8 d5 f1 ff ff       	call   8001c4 <sys_page_alloc>
  ...
  801023:	e8 fb f1 ff ff       	call   800223 <sys_page_map>
...
devcons_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  801176:	e8 2d ef ff ff       	call   8000a8 <sys_cputs>
	int tot, m;
	char buf[128];
...
devcons_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  8011a2:	eb 31                	jmp    8011d5 <devcons_read+0x44>
	...
	while ((c = sys_cgetc()) == 0)
		sys_yield();
  8011a4:	e8 eb ef ff ff       	call   800194 <sys_yield>
	int c;
  ...
  8011b0:	e8 22 ef ff ff       	call   8000d7 <sys_cgetc>
...
cputchar(int ch)
{
  ...
  8011f1:	e8 b2 ee ff ff       	call   8000a8 <sys_cputs>
}
  8011f6:	c9                   	leave  
  8011f7:	c3                   	ret    
...
opencons(void)
{
  ...
  801288:	e8 37 ef ff ff       	call   8001c4 <sys_page_alloc>
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8012c1:	e8 9e ee ff ff       	call   800164 <sys_getenvid>
...
putch(int ch, struct printbuf *b)
{
  ...
  801335:	e8 6e ed ff ff       	call   8000a8 <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  80139e:	e8 05 ed ff ff       	call   8000a8 <sys_cputs>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801f12:	e8 16 e5 ff ff       	call   80042d <sys_ipc_recv>
    if (ret) return ret;
...
//cprintf("ipc_send: sys_yield\n");
        sys_yield();
  801f89:	e8 06 e2 ff ff       	call   800194 <sys_yield>
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
	// LAB 4: Your code here.
	if (!pg) pg = (void*)-1;
  ...
  801fa0:	e8 54 e4 ff ff       	call   8003f9 <sys_ipc_try_send>
