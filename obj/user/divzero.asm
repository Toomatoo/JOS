...
umain(int argc, char **argv)
{
  ...
  800059:	c7 04 24 40 13 80 00 	movl   $0x801340,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8001f6:	e8 85 0e 00 00       	call   801080 <__udivdi3>
  ...
  800249:	e8 62 0f 00 00       	call   8011b0 <__umoddi3>
  80024e:	89 7c 24 04          	mov    %edi,0x4(%esp)
  800252:	0f be 80 58 13 80 00 	movsbl 0x801358(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80037a:	ff 24 85 40 14 80 00 	jmp    *0x801440(,%eax,4)
		case '6':
		case '7':
		case '8':
		case '9':
  ...
  800458:	c7 44 24 04 70 13 80 	movl   $0x801370,0x4(%esp)
  80045f:	00 
  ...
  80047e:	c7 44 24 04 74 13 80 	movl   $0x801374,0x4(%esp)
  800485:	00 
  ...
  8004a4:	c7 44 24 04 78 13 80 	movl   $0x801378,0x4(%esp)
  8004ab:	00 
  ...
  8004ca:	c7 44 24 04 7c 13 80 	movl   $0x80137c,0x4(%esp)
  8004d1:	00 
  ...
  8004f0:	c7 44 24 04 80 13 80 	movl   $0x801380,0x4(%esp)
  8004f7:	00 
  ...
  800516:	c7 44 24 04 84 13 80 	movl   $0x801384,0x4(%esp)
  80051d:	00 
  ...
  800588:	c7 44 24 08 91 13 80 	movl   $0x801391,0x8(%esp)
  80058f:	00 
  ...
  8005bd:	b8 69 13 80 00       	mov    $0x801369,%eax
