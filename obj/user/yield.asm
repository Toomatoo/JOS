...
umain(int argc, char **argv)
{
  ...
  80006d:	c7 04 24 c0 13 80 00 	movl   $0x8013c0,(%esp)
...
umain(int argc, char **argv)
{
  ...
  80008d:	c7 04 24 ec 13 80 00 	movl   $0x8013ec,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80022e:	e8 bd 0e 00 00       	call   8010f0 <__udivdi3>
  ...
  800281:	e8 9a 0f 00 00       	call   801220 <__umoddi3>
  800286:	89 7c 24 04          	mov    %edi,0x4(%esp)
  80028a:	0f be 80 15 14 80 00 	movsbl 0x801415(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8003b2:	ff 24 85 00 15 80 00 	jmp    *0x801500(,%eax,4)
		case '6':
		case '7':
		case '8':
		case '9':
  ...
  800490:	c7 44 24 04 2d 14 80 	movl   $0x80142d,0x4(%esp)
  800497:	00 
  ...
  8004b6:	c7 44 24 04 31 14 80 	movl   $0x801431,0x4(%esp)
  8004bd:	00 
  ...
  8004dc:	c7 44 24 04 35 14 80 	movl   $0x801435,0x4(%esp)
  8004e3:	00 
  ...
  800502:	c7 44 24 04 39 14 80 	movl   $0x801439,0x4(%esp)
  800509:	00 
  ...
  800528:	c7 44 24 04 3d 14 80 	movl   $0x80143d,0x4(%esp)
  80052f:	00 
  ...
  80054e:	c7 44 24 04 41 14 80 	movl   $0x801441,0x4(%esp)
  800555:	00 
  ...
  8005c0:	c7 44 24 08 4e 14 80 	movl   $0x80144e,0x8(%esp)
  8005c7:	00 
  ...
  8005f5:	b8 26 14 80 00       	mov    $0x801426,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800d72:	00 
  800d73:	c7 44 24 08 84 16 80 	movl   $0x801684,0x8(%esp)
  800d7a:	00 
  800d7b:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d82:	00 
  800d83:	c7 04 24 a1 16 80 00 	movl   $0x8016a1,(%esp)
  800d8a:	e8 09 03 00 00       	call   801098 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800e31:	00 
  800e32:	c7 44 24 08 84 16 80 	movl   $0x801684,0x8(%esp)
  800e39:	00 
  800e3a:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e41:	00 
  800e42:	c7 04 24 a1 16 80 00 	movl   $0x8016a1,(%esp)
  800e49:	e8 4a 02 00 00       	call   801098 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800e8f:	00 
  800e90:	c7 44 24 08 84 16 80 	movl   $0x801684,0x8(%esp)
  800e97:	00 
  800e98:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e9f:	00 
  800ea0:	c7 04 24 a1 16 80 00 	movl   $0x8016a1,(%esp)
  800ea7:	e8 ec 01 00 00       	call   801098 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800eed:	00 
  800eee:	c7 44 24 08 84 16 80 	movl   $0x801684,0x8(%esp)
  800ef5:	00 
  800ef6:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800efd:	00 
  800efe:	c7 04 24 a1 16 80 00 	movl   $0x8016a1,(%esp)
  800f05:	e8 8e 01 00 00       	call   801098 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800f4b:	00 
  800f4c:	c7 44 24 08 84 16 80 	movl   $0x801684,0x8(%esp)
  800f53:	00 
  800f54:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800f5b:	00 
  800f5c:	c7 04 24 a1 16 80 00 	movl   $0x8016a1,(%esp)
  800f63:	e8 30 01 00 00       	call   801098 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800fa9:	00 
  800faa:	c7 44 24 08 84 16 80 	movl   $0x801684,0x8(%esp)
  800fb1:	00 
  800fb2:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800fb9:	00 
  800fba:	c7 04 24 a1 16 80 00 	movl   $0x8016a1,(%esp)
  800fc1:	e8 d2 00 00 00       	call   801098 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  80103a:	00 
  80103b:	c7 44 24 08 84 16 80 	movl   $0x801684,0x8(%esp)
  801042:	00 
  801043:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80104a:	00 
  80104b:	c7 04 24 a1 16 80 00 	movl   $0x8016a1,(%esp)
  801052:	e8 41 00 00 00       	call   801098 <_panic>
...
sys_change_pr(int pr)
{
  ...
  80106a:	89 5d f4             	mov    %ebx,-0xc(%ebp)
  80106d:	89 75 f8             	mov    %esi,-0x8(%ebp)
  801070:	89 7d fc             	mov    %edi,-0x4(%ebp)
	//
	// The last clause tells the assembler that this can
	// potentially change the condition codes and arbitrary
	// memory locations.
  ...
  801078:	b8 0d 00 00 00       	mov    $0xd,%eax
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  80109d:	83 ec 20             	sub    $0x20,%esp
	...
	va_start(ap, fmt);
  8010a0:	8d 75 14             	lea    0x14(%ebp),%esi

	// Print the panic message
	cprintf("[%08x] user panic in %s at %s:%d: ",
  8010a3:	8b 1d 00 20 80 00    	mov    0x802000,%ebx
  8010a9:	e8 ee fc ff ff       	call   800d9c <sys_getenvid>
  8010ae:	8b 55 0c             	mov    0xc(%ebp),%edx
  8010b1:	89 54 24 10          	mov    %edx,0x10(%esp)
  8010b5:	8b 55 08             	mov    0x8(%ebp),%edx
  8010b8:	89 54 24 0c          	mov    %edx,0xc(%esp)
  8010bc:	89 5c 24 08          	mov    %ebx,0x8(%esp)
  8010c0:	89 44 24 04          	mov    %eax,0x4(%esp)
  8010c4:	c7 04 24 b0 16 80 00 	movl   $0x8016b0,(%esp)
  8010cb:	e8 d7 f0 ff ff       	call   8001a7 <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  8010d0:	89 74 24 04          	mov    %esi,0x4(%esp)
  8010d4:	8b 45 10             	mov    0x10(%ebp),%eax
  8010d7:	89 04 24             	mov    %eax,(%esp)
  8010da:	e8 67 f0 ff ff       	call   800146 <vcprintf>
	cprintf("\n");
  8010df:	c7 04 24 d4 16 80 00 	movl   $0x8016d4,(%esp)
  8010e6:	e8 bc f0 ff ff       	call   8001a7 <cprintf>

	// Cause a breakpoint exception
	while (1)
		asm volatile("int3");
  8010eb:	cc                   	int3   
  8010ec:	eb fd                	jmp    8010eb <_panic+0x53>
	...
